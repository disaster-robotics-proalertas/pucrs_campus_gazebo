...
public class RosBridge {
     ...
     */
   public LinkedList<Percept> getAllPercepts() throws Exception{
        int timeout=500; 
...
//                    throw new Exception("timeout. no valid action-id available in time");
//                }
//            }
    	}
...
//		ret.add(new Percept("map", new Identifier("agTest")));
//		ret.add(new Percept("seedCapital", new Numeral(3)));
//		return ret;
        }
